...
def apply_template(example):
    example["conversations"] = tokenizer.apply_chat_template(example['conversations'], tokenize=False, add_generation_prompt=True)
    return example
...
#     # training params
#     per_device_train_batch_size=24, # in the paper they use a total bs of 64. For 3 gpus we need at least 22
...
#     adam_beta1=0.9, # in the paper they use 0.9 for pretraining and hfrl, but they don't specify it for sft
#     adam_beta2=0.95, # in the paper they use 0.95 for pretraining and hfrl, but they don't specify it for sft
#     adam_epsilon=1e-5, # in the paper they use 1e-5 for pretraining and hfrl, but they don't specify it for sft
# )
# trainer = SFTTrainer(
#     model,
#     tokenizer=tokenizer,
...
#     args=sft_config,
# )
# trainer.train(resume_from_checkpoint="/home/sauron/davidmontero/llm_healing/sfttrainer/checkpoint-16500")